rule generate_report:
    ...
    shell: """
    python3 workflow/scripts/run_report.py --run-id {config[name]} --samplesheet {input.samplesheet} --summary {input.summary} --long-form-summary {input.long_form} --outdir results \
