rule general_stats:
    ...
    log: "results/logs/{sample}.general_stats.log"
...
rule insertion_sizes:
    ...
    conda: "../envs/full.yaml"
    log: "results/logs/{sample}.insertion_sizes.log"
...
rule conversion:
    ...
    conda: "../envs/full.yaml"
    log: "results/logs/{sample}.conversion.log"
...
rule summary_stats:
    input:  long_form = "results/QC_files/{sample}_long_form_reconstruction_stats.csv", 
            ...
            bam = "results/{sample}.stitched.molecules.sorted.bam"
    output: summary_file = "results/QC_files/{sample}_summary_stats.csv"
    log: "results/logs/{sample}.summary_stats.log"
    threads: 1
